...
<head>
    ...
    <title>About us -Indian Bank</title>
...
<body style="background-color:lightblue;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background-color:rgba(0,0,0,1); padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white;">About Us</h1>
            </div>
            <p style="color:red;">This website is created by</p>
            <h1 style="color:Blue; text-shadow:2px 2px 2px gray;">Arti Choudhari</h1>
