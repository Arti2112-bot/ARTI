...
<head>
    ...
    left: 0;
    z-index: 20;
    background: rgb(0,0,255) center no-repeat;
    text-align:center;
        }
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar blue bg-blue fixed fixed-top"
    ...
    <div class="container-large"
        style="color:Blue; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:lightblue;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Indian
                        Bank!</b></p>
            </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            style="backdrop-filter: blur(10px); box-shadow:3px 3px 15px white; border-radius:30px; padding:20px 0px 20px 0px;">
